<form action="prefs.webdisk.php?save=true&sid={$sid}" method="post" onsubmit="spin(this)">
	<fieldset>
		...
		<table>
			<tr>
				<td width="40" valign="top" rowspan="2"><img src="{$tpldir}images/ico_disk.png" border="0" alt="" width="32" height="32" /></td>				
				<td class="td1" width="220">{lng p="storein"}:</td>
				<td class="td2"><select name="blobstorage_provider_webdisk">
			...
			<tr>
				...
				<td class="td2">
					<label>
						<input name="blobstorage_webdisk_compress"{if $bm_prefs.blobstorage_webdisk_compress=='yes'} checked="checked"{/if} type="checkbox" />
						{lng p="enable"}
					</label>
