...
<div class="row row-cards">
	<div class="col-md-8">
		<div class="row row-cards">
			<div class="col-md-6">
				<div class="card" style="margin-bottom: 20px;">
					<div class="card-header">{lng p="users"}</div>
			...
			<div class="col-md-6">
				<div class="card" style="margin-bottom: 20px;">
					<div class="card-header">{lng p="version"}</div>
					<table class="table table-vcenter table-striped card-table">
						<tbody>
						<tr>
		...
		<div class="row row-cards">
			<div class="col-md-6">
				<div class="card" style="margin-bottom: 20px;">
					<div class="card-header">{lng p="email"}</div>
					<table class="table table-vcenter table-striped card-table">
						<tbody>
						<tr>
			...
			<div class="col-md-6">
				<div class="card" style="margin-bottom: 20px;">
					<div class="card-header">{lng p="webserver"}</div>
					<table class="table table-vcenter table-striped card-table">
						<tbody>
						<tr>
		...
		<div class="row row-cards">
			<div class="col-md-6">
				<div class="card" style="margin-bottom: 20px;">
					<div class="card-header">{lng p="webdisk"}</div>
					<table class="table table-vcenter table-striped card-table">
						<tbody>
						<tr>
			...
			<div class="col-md-6">
				<div class="card" style="margin-bottom: 20px;">
					<div class="card-header">{lng p="db"}</div>
					<table class="table table-vcenter table-striped card-table">
						<tbody>
						<tr>
	...
	<div class="col-md-4">
		...
		<div class="card" style="margin-bottom: 20px;">
			<div class="card-header">{lng p="notes"}</div>
		...
		{if $showActivation}
		<div class="card" style="margin-bottom: 20px;">
			<div class="card-header">{lng p="activatepayment"}</div>
			<div class="card-body">
