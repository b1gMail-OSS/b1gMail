...
<form name="f2" method="post" action="organizer.calendar.php?action=groups&do={if $group}save&id={$group.id}{else}add{/if}{$sessionUrlSuffix}" onsubmit="return(checkCalendarGroupForm(this));">
	{csrffield}
