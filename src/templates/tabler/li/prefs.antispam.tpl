	...
	<table class="listTable">
		...
		<tr>
			...
			<td class="listTableRight">
				<label class="form-check mb-0"><input type="checkbox" class="form-check-input" name="spamfilter" id="spamfilter"{if $spamFilter} checked="checked"{/if} /><span class="form-check-label"><b>{lng p="enable"}</b></span></label>
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="unspamme">{lng p="unspamme"}:</label></td>
			<td class="listTableRight">
				<label class="form-check mb-0"><input type="checkbox" class="form-check-input" name="unspamme" id="unspamme"{if $unspamMe} checked="checked"{/if} /><span class="form-check-label"><b>{lng p="marknonspam"}</b></span></label>
			</td>
		</tr>
		<tr>
			<td class="listTableLeft"><label for="addressbook_nospam">{lng p="mailsfromab"}:</label></td>
			<td class="listTableRight">
				<label class="form-check mb-0"><input type="checkbox" class="form-check-input" name="addressbook_nospam" id="addressbook_nospam"{if $addressbookNoSpam} checked="checked"{/if} /><span class="form-check-label"><b>{lng p="marknonspam"}</b></span></label>
			</td>
		</tr>
		{if $localMode}
		<tr>
