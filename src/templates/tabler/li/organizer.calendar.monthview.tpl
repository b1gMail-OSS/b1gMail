	...
	<div class="scrollContainer withBottomBar bm-organizer-calendar-body bm-organizer-calendar-month" id="calendarContainer">
		...
		<table class="bigTable bm-organizer-month-table">
			...
			<tr class="bm-organizer-month-week">
				...
				<td valign="top" class="monthCell{if $day.today}Today{/if} bm-organizer-month-cell" data-day-timestamp="{$day.dayStart}">
					...
					<div class="monthDate_{$date.displayColor} bm-organizer-month-event" onclick="showCalendarDate({$date.id}, {$date.startdate}, {$date.enddate}, false)">
