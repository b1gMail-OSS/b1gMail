...
<table class="bigTable">
	...
	<tr>
		...
		<td class="{$class}" nowrap="nowrap">
			...
			<a onclick="return confirm('{lng p="realdel"}');" href="organizer.calendar.php?action=groups&do=delete&id={$groupID}{$sessionUrlSuffix}&csrf_token={$csrfToken}"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
		</td>
	</tr>
	{/if}
	{/foreach}
