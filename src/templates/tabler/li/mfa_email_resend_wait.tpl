<div class="mt-2 text-center" id="bmMfaResendWrap"{if $mfaEmailCodeExpiresAt|default:0 > 0} data-expires-at="{$mfaEmailCodeExpiresAt|escape}" data-wait-prefix="{$mfaResendWaitPrefix|escape}"{/if}>
	...
	<div class="text-secondary small mt-1" id="bmMfaResendWait"{if $mfaEmailCodeExpiresAt|default:0 <= 0} style="display:none;"{/if}></div>
</div>
