		...
		<tr>
			...
			<td class="listTableRight">
				{foreach from=$groups item=group key=groupID}
					<label class="form-check mb-0"><input type="checkbox" class="form-check-input" id="group_{$groupID}" name="group_{$groupID}" /><span class="form-check-label">{text value=$group.title cut=18}</span></label><br />
				{/foreach}

				<label class="form-check mb-0"><input type="checkbox" class="form-check-input" id="group_new" name="group_new" /></label>
