...
{if isset($prefsIcons[$item])}
	{assign var=prefsIconSrc value=$prefsIcons[$item]}
	{if $prefsIconSrc|regex_replace:'/^https?:\/\/.*/':'' == '' || $prefsIconSrc|substr:0:1 == '/'}
		<img src="{$prefsIconSrc}" width="20" height="20" class="bm-prefs-item-icon-img" alt="" />
	{else}
		<img src="{$selfurl}{$prefsIconSrc}" width="20" height="20" class="bm-prefs-item-icon-img" alt="" />
	{/if}
