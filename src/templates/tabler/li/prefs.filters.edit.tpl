...
<div class="scrollContainer bm-prefs-body"><div class="pad bm-prefs-form-pad">
	<table class="listTable">
		...
		<tr>
			...
			<td class="listTableRight">
				<label class="form-check mb-0"><input type="checkbox" class="form-check-input" id="active" name="active"{if $filter.active} checked="checked"{/if} /></label>
			</td>
		</tr>
		...
		<tr>
			...
			<td class="listTableRight">
				<label class="form-check mb-0"><input type="checkbox" class="form-check-input" name="flags[]" value="2"{if $filter.flags&2} checked="checked"{/if} id="flag2" /><span class="form-check-label">{lng p="nospamoverride"}</span></label>
			</td>
		</tr>
