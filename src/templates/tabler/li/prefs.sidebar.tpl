...
<div class="contentMenuIcons bm-prefs-sidebar-nav">
	<a href="{sessionurl file='prefs.php'}"{if $pageContent=='li/prefs.start.tpl'} class="active"{/if}>
	...
	<a href="{sessionurl file='prefs.php' params="action={$item}"}"{if $pageContent=="li/prefs.$item.tpl" || $pageContent|substr:0:($_prefsPrefix|count_characters)==$_prefsPrefix} class="active"{/if}>
