<div data-role="header" data-position="fixed">
	<a href="calendar.php" data-icon="arrow-l" data-direction="reverse" data-transition="slide">{lng p="calendar"}</a>
	<h1>{$pageTitle}</h1>
</div>
...
<div data-role="content">
	...
	<a href="email.php?action=compose&to={$mailTo}&subject={$mailSubject}" data-role="button">{lng p="mailattendees"}</a>
	{/if}
