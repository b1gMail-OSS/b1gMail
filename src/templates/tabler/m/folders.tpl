<div data-role="header" data-position="fixed">
	<h1>{$pageTitle}</h1>
	<a href="email.php?action=compose" data-icon="forward" data-iconpos="right" class="ui-btn-right">{lng p="sendmail"}</a>
</div>
...
<div data-role="content">
	...
	{foreach from=$folders item=folder key=folderID}
		<li>
			<a href="email.php?folder={$folderID}&id={$mailID}" data-transition="slide">
