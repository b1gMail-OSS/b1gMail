...
<table class="bigTable">
	...
	<tr>
		...
		<td class="{if $sortColumn=='title'}listTableTDActive{else}{$class}{/if}" nowrap="nowrap">&nbsp;<a href="{sessionurl file='prefs.php' params="action=filters&do=edit&id={$filterID}"}"><i class="fa fa-filter" aria-hidden="true"></i> {text value=$filter.title}</a></td>
		...
		<td class="{if $sortColumn=='orderpos'}listTableTDActive{else}{$class}{/if}" nowrap="nowrap">&nbsp;{$filter.orderpos}
			<a href="{sessionurl file='prefs.php' params="action=filters&down={$filterID}"}"><i class="fa fa-arrow-down" aria-hidden="true"></i></a>
			<a href="{sessionurl file='prefs.php' params="action=filters&up={$filterID}"}"><i class="fa fa-arrow-up" aria-hidden="true"></i></td>
...
<div id="contentFooter">
	...
	<div class="right">
		<button type="button" class="primary" onclick="document.location.href='{sessionurl file='prefs.php' params='action=filters&do=add'}';">
