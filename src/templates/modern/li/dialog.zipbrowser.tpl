...
<body onload="documentLoader()">
	...
	<table width="100%">
		...
		<tr>
			<td align="left">
				<input type="button" onclick="document.location.href='{sessionurl file='email.read.php' params="id={$id}&action=downloadAttachment&attachment={$attachment}"}';" value="{lng p="download"}" />
			</td>
			<td align="right">
