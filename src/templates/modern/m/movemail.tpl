<div id="leftTopButtons">
	<a class="hButton" href="{sessionurl file='main.php' params="action=read&id={$mailID}"}">
...
<div id="content" class="white noFooter">
	...
	{if !$folder.intelligent}
		<li>
			<a href="{if $folderID!=$currentFolder}main.php?action=moveMail&id={$mailID}&to={$folderID}{else}main.php?folder={$folderID}{/if}" class="high">
