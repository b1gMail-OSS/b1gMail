...
$lang_client['push_enabled_ok']	= 'Les notifications push du navigateur ont été activées.';
$lang_client['push_enabled_fail']= 'Impossible d\'activer les notifications push. Vérifiez HTTPS et l\'autorisation du navigateur.';
$lang_client['push_test_ok']		= 'Notification test envoyée (%%n%% appareil(s)).';
$lang_client['push_test_fail']	= 'Échec de la notification test.';
$lang_client['push_test_fail_nosub']	= 'Aucun abonnement push sur le serveur – réactivez les notifications push.';
$lang_client['push_test_fail_noprefs']	= 'Push non enregistré dans b1gMail – réactivez les notifications push.';
$lang_client['push_test_fail_delivery']	= 'Échec de l\'envoi – désactivez puis réactivez les notifications push.';
$lang_client['push_test_fail_mailtype']	= 'Le type « Nouveaux e-mails » est désactivé.';
...
$lang_client['stopsharing_confirm']	= 'Voulez-vous vraiment arrêter le partage de ce dossier?';
...
$lang_client['wd_filetoolarge']	= 'Le fichier est trop volumineux. Maximum autorisé : %s.';
$lang_client['wd_upload_failed']	= 'Échec du téléversement';
$lang_client['wd_fileforbidden']	= 'Ce type de fichier n\'est pas autorisé.';
...
$lang_client['wd_selection_detail']	= '%d éléments (%f fichiers, %o dossiers)';
$lang_client['wd_text_saved']		= 'Fichier enregistré.';
$lang_client['wd_text_save_fail']	= 'Échec de l\'enregistrement.';
$lang_client['wd_text_binary']		= 'Ce fichier contient des données binaires et ne peut pas être modifié en texte.';
$lang_client['wd_text_toolarge']	= 'Ce fichier est trop volumineux pour l\'édition de texte (max. %s).';
$lang_client['wd_text_unsaved']		= 'Des modifications ne sont pas enregistrées. Fermer l\'aperçu ?';
...
$lang_custom['notify_wd_share_expired'] = 'Partage Webdisk expiré : <strong>%s</strong>';
$lang_custom['notify_wd_share_download'] = 'Téléchargement depuis un partage : <strong>%s</strong> (dossier : %s)';
...
$lang_user['push_prompt_text_short'] = 'Alertes push pour nouveaux e-mails et rendez-vous – même sans onglet ouvert.';
$lang_user['push_prompt_decline'] = 'Ne pas activer';
$lang_user['push_enable']		= 'Activer le push';
$lang_user['push_disable']		= 'Désactiver le push';
$lang_user['push_enabled_ok']	= 'Les notifications push du navigateur ont été activées.';
$lang_user['push_enabled_fail']	= 'Impossible d\'activer les notifications push.';
$lang_user['push_disabled_ok']	= 'Les notifications push du navigateur ont été désactivées.';
$lang_user['push_test']			= 'Envoyer une notification test';
$lang_user['push_test_devices']	= 'La notification test est envoyée à tous les appareils enregistrés (ex. ordinateur et téléphone).';
$lang_user['push_test_body']	= 'Ceci est une notification test.';
$lang_user['push_test_ok']		= 'Notification test envoyée (%%n%% appareil(s)).';
$lang_user['push_test_fail']	= 'Échec de la notification test – réactivez le push ou enregistrez les paramètres.';
$lang_user['push_test_fail_nosub']	= 'Aucun abonnement push sur le serveur – cliquez sur « Activer le push » (HTTPS requis).';
$lang_user['push_test_fail_noprefs']	= 'Le push fonctionne dans le navigateur mais n\'est pas enregistré dans b1gMail – cliquez à nouveau sur « Activer le push ».';
$lang_user['push_test_fail_delivery']	= 'Échec d\'envoi au service push (VAPID/réseau ?) – désactivez puis réactivez le push.';
$lang_user['push_test_fail_mailtype']	= 'Le type « Nouveaux e-mails » est désactivé (uniquement pour les vrais e-mails).';
$lang_user['push_type_mail']	= 'Nouveaux e-mails';
$lang_user['push_type_mail_filter'] = 'E-mails (filtre)';
$lang_user['push_type_calendar']	= 'Rendez-vous du calendrier';
$lang_user['push_type_birthday']	= 'Anniversaires';
$lang_user['push_type_task']		= 'Tâches';
$lang_user['push_type_webdisk']	= 'Partages Webdisk';
...
$lang_user['wd_preview_prev']		= 'Fichier précédent';
$lang_user['wd_preview_next']		= 'Fichier suivant';
$lang_user['wd_preview_pdf_prev']	= 'Page précédente';
$lang_user['wd_preview_pdf_next']	= 'Page suivante';
$lang_user['wd_preview_pdf_pages']	= 'Pages PDF';
$lang_user['wd_text_saved']			= 'Fichier enregistré.';
$lang_user['wd_text_save_fail']		= 'Échec de l\'enregistrement.';
$lang_user['wd_text_binary']		= 'Ce fichier contient des données binaires et ne peut pas être modifié en texte.';
$lang_user['wd_text_toolarge']		= 'Ce fichier est trop volumineux pour l\'édition de texte (max. %s).';
$lang_user['wd_text_unsaved']		= 'Des modifications ne sont pas enregistrées. Fermer l\'aperçu ?';
$lang_user['wd_text_notfound']		= 'Fichier introuvable.';
...
$lang_user['wd_filetoolarge']		= '« %s » est trop volumineux. Maximum autorisé : %s.';
$lang_user['wd_upload_posttoolarge']	= 'Téléversement interrompu : la requête dépasse la limite du serveur (%s).';
$lang_user['wd_upload_php_limit']	= 'Le fichier dépasse la limite d\'envoi PHP du serveur.';
$lang_user['wd_upload_partial']		= 'Le fichier n\'a été téléversé que partiellement.';
$lang_user['wd_upload_nofile']		= 'Aucun fichier valide reçu.';
$lang_user['wd_fileforbidden']		= 'Ce type de fichier n\'est pas autorisé.';
$lang_user['wd_upload_nofiles']		= 'Veuillez sélectionner au moins un fichier.';
$lang_user['wd_upload_maxsize']		= 'Taille maximale du fichier';
$lang_user['wd_upload_widget']		= 'Fichiers depuis l\'ordinateur';
$lang_user['wd_upload_widget_note']	= 'Sélection simple ou multiple (comme le widget de pièce jointe).';
$lang_user['wd_upload_multifile']	= 'Plusieurs fichiers à la fois';
$lang_user['wd_upload_multifile_note']	= 'Champ supplémentaire pour une sélection multiple groupée.';
$lang_user['wd_upload_dnd_note']	= 'Les fichiers sont envoyés directement dans le dossier actuel.';
$lang_user['wd_upload_files_note']	= 'Vous pouvez sélectionner plusieurs fichiers à la fois.';
$lang_user['wd_upload_or']			= 'ou';
$lang_user['wd_upload_restrictions']	= 'Restrictions définies par l\'administrateur';
$lang_user['wd_upload_forbidden_ext']	= 'Extensions interdites';
$lang_user['wd_upload_forbidden_mime']	= 'Types MIME interdits';
...
$lang_user['stopsharing']		= 'Arrêter le partage';
$lang_user['stopsharing_confirm']	= 'Voulez-vous vraiment arrêter le partage de ce dossier?';
$lang_user['wd_share_expiry']		= 'Date d\'expiration';
$lang_user['wd_share_expiry_d']	= 'Date de fin optionnelle pour ce partage.';
$lang_user['wd_share_expiry_required']	= 'Veuillez indiquer une date d\'expiration pour ce partage.';
$lang_user['wd_share_expiry_invalid']	= 'La date d\'expiration est invalide.';
$lang_user['wd_share_expiry_maxdays_err'] = 'Le partage peut expirer au maximum dans %d jour(s).';
$lang_user['wd_share_pw_required_err']	= 'Veuillez indiquer un mot de passe pour le partage.';
$lang_user['wd_share_pw_minlength_err']	= 'Le mot de passe de partage doit contenir au moins 12 caractères.';
$lang_user['wd_share_single_use']	= 'Lien à usage unique';
$lang_user['wd_share_file_link']	= 'Lien de partage de fichier';
...
$lang_user['addattendee']		= 'Ajouter des participants';
...
$lang_user['deref_title']		= 'Redirection';
$lang_user['deref_redirect']	= 'Le lien s&eacute;lectionn&eacute; se trouve en dehors de notre site. Pour ouvrir la page de destination, veuillez cliquer sur le lien suivant.';
$lang_user['deref_back']		= 'Si vous ne souhaitez pas visiter cette page, <a href="#" onclick="self.close(); return false;">fermez cette fen&ecirc;tre</a>.';
$lang_user['deref_linklabel']	= 'Adresse de destination';
$lang_user['deref_continue']	= 'Continuer vers le lien';
$lang_user['deref_close']		= 'Fermer la fen&ecirc;tre';
$lang_user['deref_safe_title']	= 'Lien v&eacute;rifi&eacute;';
$lang_user['deref_safe_text']	= 'Cette adresse a &eacute;t&eacute; v&eacute;rifi&eacute;e via Google Web Risk et class&eacute;e comme s&ucirc;re.';
$lang_user['deref_unsafe_title']	= 'Avertissement : lien suspect';
$lang_user['deref_unsafe_text']	= 'Cette adresse a &eacute;t&eacute; signal&eacute;e comme potentiellement dangereuse (logiciel malveillant, hame&ccedil;onnage ou logiciel ind&eacute;sirable). Nous vous recommandons de ne pas ouvrir le lien.';
$lang_user['deref_invalid_title']	= 'Le lien n\'a pas pu &ecirc;tre v&eacute;rifi&eacute;';
$lang_user['deref_invalid_text']	= 'L\'adresse de destination est invalide ou non prise en charge. Veuillez v&eacute;rifier l\'adresse attentivement avant de continuer.';
$lang_user['deref_unavailable_title']	= 'Le lien n\'a pas pu &ecirc;tre v&eacute;rifi&eacute;';
$lang_user['deref_unavailable_text']	= 'Nous n\'avons pas pu v&eacute;rifier cette adresse automatiquement pour le moment. Veuillez examiner l\'adresse ci-dessous et n\'ouvrir le lien que si vous faites confiance au site.';
$lang_user['deref_continueanyway']	= 'Continuer quand m&ecirc;me';
$lang_user['deref_threat_label']	= 'Cat&eacute;gorie';
$lang_user['deref_threat_malware']	= 'Logiciel malveillant';
$lang_user['deref_threat_phishing']	= 'Hame&ccedil;onnage / fraude';
$lang_user['deref_threat_unwanted']	= 'Logiciel ind&eacute;sirable';
$lang_user['dsDerefTitle']			= $lang_user['deref_title'];
$lang_user['dsDerefRedirect']		= $lang_user['deref_redirect'];
$lang_user['dsDerefBack']			= $lang_user['deref_back'];
$lang_user['dsDerefLinkLabel']		= $lang_user['deref_linklabel'];
$lang_user['dsDerefContinue']		= $lang_user['deref_continue'];
$lang_user['dsDerefClose']			= $lang_user['deref_close'];
$lang_user['dsDerefSafeTitle']		= $lang_user['deref_safe_title'];
$lang_user['dsDerefSafeText']		= $lang_user['deref_safe_text'];
$lang_user['dsDerefUnsafeTitle']	= $lang_user['deref_unsafe_title'];
$lang_user['dsDerefUnsafeText']		= $lang_user['deref_unsafe_text'];
$lang_user['dsDerefInvalidTitle']	= $lang_user['deref_invalid_title'];
$lang_user['dsDerefInvalidText']	= $lang_user['deref_invalid_text'];
$lang_user['dsDerefUnavailableTitle']	= $lang_user['deref_unavailable_title'];
$lang_user['dsDerefUnavailableText']	= $lang_user['deref_unavailable_text'];
$lang_user['dsDerefContinueAnyway']	= $lang_user['deref_continueanyway'];
$lang_user['dsDerefThreatLabel']	= $lang_user['deref_threat_label'];
$lang_user['dsDerefThreatMalware']	= $lang_user['deref_threat_malware'];
$lang_user['dsDerefThreatPhishing']	= $lang_user['deref_threat_phishing'];
$lang_user['dsDerefThreatUnwanted']	= $lang_user['deref_threat_unwanted'];
...
$lang_admin['wd_share_pw_required']	= 'Exiger un mot de passe pour les partages';
$lang_admin['wd_share_expiry_required']	= 'Exiger une date d\'expiration pour les partages';
$lang_admin['wd_share_max_days']	= 'Durée maximale de partage (jours)';
$lang_admin['wd_share_max_days_d']	= '0 = illimité, sinon nombre maximal de jours jusqu\'à expiration.';
...
$lang_admin['push_settings']	= 'Web Push / PWA';
$lang_admin['push_enable_global'] = 'Activer Web Push';
$lang_admin['push_vapid_subject'] = 'Contact VAPID (mailto: ou https://)';
$lang_admin['push_vapid_keys']	= 'Clés VAPID';
$lang_admin['push_vapid_configured'] = 'Les clés sont configurées.';
$lang_admin['push_vapid_missing'] = 'Pas encore de clés – veuillez les générer.';
$lang_admin['push_generate_vapid'] = 'Générer les clés VAPID';
$lang_admin['push_vapid_generated_ok'] = 'Les clés VAPID ont été générées et enregistrées.';
$lang_admin['push_vapid_generated_fail'] = 'Impossible d\'enregistrer les clés VAPID. Vérifiez OpenSSL PHP et les colonnes de la base de données.';
$lang_admin['push_vapid_openssl_missing'] = 'PHP n\'a pas le support OpenSSL EC (openssl_pkey_new / prime256v1).';
...
$lang_admin['clamwarning']		= 'N’activez ClamAV que si clamd tourne sur ce serveur (ou l’hôte indiqué). Sous Debian/Ubuntu, le socket Unix est recommandé.';
$lang_admin['clamd_off']		= 'Désactivé';
$lang_admin['clamd_off_desc']	= 'Pas de scan antivirus ClamAV à la réception des e-mails.';
$lang_admin['clamd_socket']		= 'Socket Unix';
$lang_admin['clamd_socket_desc']= 'Connexion locale via le socket clamd (recommandé, ex. /var/run/clamav/clamd.ctl).';
$lang_admin['clamd_tcp']		= 'Nom d’hôte et port';
$lang_admin['clamd_tcp_desc']	= 'Connexion TCP à clamd (uniquement si TCPSocket/TCPAddr est configuré).';
$lang_admin['clamd_socket_path']= 'Chemin du socket';
$lang_admin['clamd_socket_ok']	= 'Socket trouvé sur ce serveur.';
$lang_admin['clamd_socket_missing'] = 'Socket actuellement inaccessible pour l’utilisateur PHP/serveur web';
$lang_admin['clamd_socket_permhint'] = 'Cause fréquente : /run/clamav n’est accessible qu’au groupe clamav. Solution : ajouter l’utilisateur du serveur web au groupe clamav (ex. usermod -aG clamav www-data) puis redémarrer PHP-FPM/Apache.';
...
$lang_admin['wd_thumbnails']		= 'Vignettes Webdisk';
$lang_admin['wd_thumbnails_desc']	= 'Afficher des vignettes pour les images dans le dossier';
