				...
				<div class="mb-3 row">
					...
					<div class="col-sm-8">
						...
						{foreach from=$groups item=group}
							<label class="form-check">
								<input class="form-check-input" type="checkbox" name="groups[]" value="{$group.id}" id="group_{$group.id}" onclick="if(this.checked) EBID('all_groups').checked=false;"{if !empty($group.checked)} checked="checked"{/if}>
