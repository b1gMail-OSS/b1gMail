		...
		<div class="row">
			<div class="col-md-6">
				<div class="input-group mb-2">
					...
					<input class="btn btn-primary" type="submit" value=" {lng p="show"} &raquo; " />
				</div>
			</div>
			<div class="col-md-6 text-end"><a href="#" class="btn btn-primary" onclick="if(confirm('{lng p="bms_real_reset"}')) document.location.href='{$pageURL}&action=stats&do=reset&sid={$sid}';">{lng p="bms_reset_stats"}</a></div>
		</div>
	</form>
</fieldset>
