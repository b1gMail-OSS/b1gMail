<fieldset>
	...
	<table>
		<tr>
			<td align="left" rowspan="7" valign="top" width="40"><img src="../plugins/templates/images/vbulletin32.png" border="0" alt="" width="32" height="32" /></td>
			<td class="td1" width="160">{lng p="enable"}?</td>
			<td class="td2"><input name="enableAuth"{if $vb_prefs.enableAuth} checked="checked"{/if} type="checkbox" /></td>
		</tr>
		<tr>
